  ...
  <ErrorBoundary>
    <Router history={hashHistory}>
      <Route path="/" component={App}>
        ...
        <Route path="services">
          <IndexRoute
            component={Authentication(ServicesList)}
            title="Services"
          />
        ...
        <Route path="discounts">
          <IndexRoute
            component={Authentication(DiscountsList)}
            title="Discounts"
          />
        ...
        <Route path="charges">
          <IndexRoute
            component={Authentication(ChargesList)}
            title="Conditional Charges"
          />
        ...
        <Route path="products">
          <IndexRoute
            component={Authentication(ProductsList)}
            title="Products"
          />
        ...
        <Route path="prepaid_plans">
          <IndexRoute
            component={Authentication(PrepaidPlansList)}
            title="Prepaid Plans"
          />
          <Route
            path="prepaid_plan/:itemId"
            component={Authentication(PrepaidPlan)}
          />
        ...
        <Route path="charging_plans">
          <IndexRoute
            component={Authentication(ChargingPlansList)}
            title="Buckets Groups"
          />
          <Route
            path="charging_plan/:itemId"
            component={Authentication(ChargingPlanSetup)}
          />
          <Route
            path="charging_plan"
            component={Authentication(ChargingPlanSetup)}
        ...
        <Route path="auto_renews">
          <IndexRoute
            component={Authentication(AutoRenewsList)}
            title="Recurring Charges"
          />
          <Route
            path="auto_renew/:itemId"
            component={Authentication(AutoRenewSetup)}
          />
        ...
        <Route path="prepaid_includes">
          <IndexRoute
            component={Authentication(PrepaidIncludesList)}
            title="Prepaid Buckets"
          />
          <Route
            path="prepaid_include/:itemId"
            component={Authentication(PrepaidIncludeSetup)}
          />
          <Route
            path="prepaid_include"
            component={Authentication(PrepaidIncludeSetup)}
          />
        </Route>
        ...
        <Route path="customers">
          <IndexRoute
            component={Authentication(CustomersList)}
            title="Customers"
          />
          <Route
            path="customer/:itemId"
            component={Authentication(CustomerSetup)}
          />
        ...
        <Route
          ...
          component={Authentication(InputProcessor)}
        />
        <Route
          path="/input_processors"
          component={Authentication(InputProcessorsList)}
          title="Input Processors"
        />
        <Route
          path="/export_generator"
          component={Authentication(ExportGenerator)}
          title="Export Generator"
        />
        <Route
          path="/export_generators"
          component={Authentication(ExportGeneratorsList)}
          title="Export Generators"
        />
        <Route
          path="/usage"
          component={Authentication(UsageList)}
          title="Usage"
        />
        <Route
          path="/run_cycle"
          component={Authentication(RunCycle)}
          title="Billing Cycle"
        />
        <Route
          path="/queue"
          component={Authentication(QueueList)}
          title="Queue"
        />
        <Route
          path="/invoices"
          component={Authentication(InvoicesList)}
          title="Invoices"
        />
        <Route
          path="/custom-payment-files"
          component={Authentication(PaymentFiles)}
          title="Custom Transactions Request File"
        />
        <Route
          path="/settings"
          component={Authentication(Settings)}
          title="General Settings"
        />
        <Route
          path="/payment_gateways"
          component={Authentication(PaymentGateways)}
          title="Payment Gateways"
        />
        <Route
          path="/select_input_processor_template"
          component={Authentication(SelectTemplate)}
          title="Create New Input Processor"
        />
        <Route
          path="/collections"
          component={Authentication(Collections)}
          title="Collection"
        />
        <Route
          path="/invoice-template"
          component={Authentication(InvoiceTemplate)}
          title="Invoice Template"
        />
        <Route
          path="/audit-trail"
          component={Authentication(AuditTrail)}
          title="Audit Trail"
        />
        <Route
          path="/custom_fields"
          component={Authentication(CustomFields)}
          title="Custom Fields"
        />
        <Route
          path="/events"
        ...
        <Route
          ...
          component={Authentication(EmailTemplates)}
        ...
        <Route
          path="/changepassword(/:itemId)"
          component={ChangePassword}
          title="Change Password"
        />
        <Route
          path="/import(/:itemType)"
          component={Authentication(ImporterSetup)}
        />
        <Route
          path="/export(/:itemType)"
          component={Authentication(ExporterSetup)}
        />
